...
3 4 +
```
há três palavras nessa instrução: os números 3 e 4 e o sinal +. 3 e 4 são inseridos na pilha de dados D, enquanto palavra + indica que os números no topo da pilha serão desempilhados, somados (4+3, note a notação polonesa inversa) e o resultado será inserido na pilha. Assim, assumindo que a pilha D esteja vazia antes dessa instrução, após a execução de "3 4 +", ela passa a ter um único elemento: 7.

# Palavras reconhecidas
Itálico representa items escritos pelo usuário.
| Palavra                  | Definição                                                                                                    |
| ------------------------ | ------------------------------------------------------------------------------------------------------------ |
...
| ( *string* )                        | Comentários                                                                                       |
| rand                                | Empilha valor aleatório entre 0 e o valor no topo da pilha D (não inclui esse valor)              |
